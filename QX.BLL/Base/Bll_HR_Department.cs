...
namespace QX.BLL
{
   ...
   public partial class Bll_Bse_Department
   {
        ...
        /// <returns>list</returns>
        public List<Bse_Department> GetListByCode(string strCondition)
        {
        ...
        public bool Insert(Bse_Department model)
        {
            bool result = false;
            try
            {
        ...
        /// <returns>bool</returns>
        public bool Insert(Bse_Department model,bool IsValid)
        { 
        ...
        public Bse_Department GetModel(string strCondition)
        {
        ...
        /// <param name='strCondition'>条件(AND Code='11')</param>
        /// <returns>model</returns>
        public Bse_Department GetModel(int id)
        {
            Bse_Department model = instance.GetByKey(id);          
            return model;
        }    
        ...
        /// <param name='model'>实体</param>
        /// <returns>bool</returns>
        public bool Update(Bse_Department model)
        {            
            bool result = false;
            var e = new ModelExceptions();
        ...
        /// <param name='model'>实体</param>
        /// <returns>bool</returns>
        public bool Update(Bse_Department model,bool IsValid)
        {
        ...
        {
            bool result = false;
            List<Bse_Department> list = instance.GetListByWhere(Condition);
            if (list.Count > 0)
            {
