...
namespace QX.BLL
{
   ...
   public partial class Bll_Sys_Config_ListPage
   {
        ...
        private ADOSys_Config_ListPage instance = new ADOSys_Config_ListPage();
        ...
        {
            List<Sys_Config_ListPage> list = instance.GetAll();
            return list;
        }
        ...
        /// <returns>list</returns>
        public List<Sys_Config_ListPage> GetListByCode(string strCondition)
        {
        ...
        /// <param name='model'>实体</param>
        /// <returns>bool</returns>
        public bool Update(Sys_Config_ListPage model,bool IsValid)
        {
