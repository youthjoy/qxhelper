...
{
   [Serializable]
   public partial class Bll_Sys_PD_Filed
   {

        private ADOSys_PD_Filed instance = new ADOSys_PD_Filed();
        ...
        {
            List<Sys_PD_Filed> list = instance.GetAll();
            return list;
        }
        ...
        /// <returns>list</returns>
        public List<Sys_PD_Filed> GetListByCode(string strCondition)
        {
        ...
        /// <param name='model'>实体</param>
        /// <returns>bool</returns>
        public bool Update(Sys_PD_Filed model,bool IsValid)
        {
