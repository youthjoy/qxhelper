...
namespace QX.BLL
{
   ...
   /// </summary>
   [Serializable]
   public partial class Bll_Sys_Rec_RefDepend
   {

        private ADOSys_Rec_RefDepend instance = new ADOSys_Rec_RefDepend();
        ...
        {
            List<Sys_Rec_RefDepend> list = instance.GetAll();
            return list;
        }
        ...
        /// <param name='model'>实体</param>
        /// <returns>bool</returns>
        public bool Update(Sys_Rec_RefDepend model,bool IsValid)
        {
