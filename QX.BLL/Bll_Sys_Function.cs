...
{
   [Serializable]
   public partial class Bll_Sys_Function
   {

      //  private ADOSys_Function instance = new ADOSys_Function();
        ...
        {
            List<Sys_Function> list = instance.GetAll();
            return list;
        }
        ...
        /// <returns></returns>
        public List<Sys_Function> GetFunctionLevelByKey()
        {
            List<Sys_Function> allData = GetAll();
            List<Sys_Function> root = allData.Where(o=>(string.IsNullOrEmpty(o.Fun_PCode)||o.Fun_PCode=="root")).ToList();
        ...
        /// <returns>list</returns>
        public List<Sys_Function> GetListByCode(string strCondition)
        {
        ...
        /// <param name='model'>实体</param>
        /// <returns>bool</returns>
        public bool Update(Sys_Function model,bool IsValid)
        {
