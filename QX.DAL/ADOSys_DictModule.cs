...
namespace QX.DAL
{
   ...
   public partial class ADOSys_DictModule
   {
      ...
      {
         string sql = "INSERT INTO Sys_DictModule (ModuleCode,CodeLength,ChildLength,TableName,CodeField,FilterSQL,Udef1,Udef2,Udef3,Udef4,Udef5) VALUES (@ModuleCode,@CodeLength,@ChildLength,@TableName,@CodeField,@FilterSQL,@Udef1,@Udef2,@Udef3,@Udef4,@Udef5)";
      ...
      {
         string sql = "INSERT INTO Sys_DictModule (ModuleCode,CodeLength,ChildLength,TableName,CodeField,FilterSQL,Udef1,Udef2,Udef3,Udef4,Udef5) VALUES (@ModuleCode,@CodeLength,@ChildLength,@TableName,@CodeField,@FilterSQL,@Udef1,@Udef2,@Udef3,@Udef4,@Udef5);SELECT @@IDENTITY AS ReturnID;";
         if (string.IsNullOrEmpty(sys_DictModule.ModuleCode))
         {
            idb.AddParameter("@ModuleCode", DBNull.Value);
         }
      ...
      public List<Sys_DictModule> GetListByWhere(string strCondition)
      {
         ...
         string sql = "SELECT  ID,ModuleCode,CodeLength,ChildLength,TableName,CodeField,FilterSQL,Udef1,Udef2,Udef3,Udef4,Udef5 FROM Sys_DictModule WHERE 1=1 AND ((Stat is null) or (Stat=0) ) ";
