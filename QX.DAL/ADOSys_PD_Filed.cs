   ...
   public partial class ADOSys_PD_Filed
   {
      ...
      public Sys_PD_Filed GetByKey(decimal dCP_ID)
      {
         ...
         while(dr.Read())
         {
            ...
            if (dr["DCP_CreateTime"] != DBNull.Value) sys_PD_Filed.DCP_CreateTime = Convert.ToDateTime(dr["DCP_CreateTime"]);
