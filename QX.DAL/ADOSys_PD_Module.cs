...
namespace QX.DAL
{
   ...
   public partial class ADOSys_PD_Module
   {
      ...
      {
         string sql = "INSERT INTO Sys_PD_Module (SPM_Module,SPM_LPrefix,SPM_Name,SPM_LX,SPM_LY,SPM_TX,SPM_TY,SPM_LI,SPM_TI,SPM_CNum,SPM_TPrefix,SPM_Height,Stat) VALUES (@SPM_Module,@SPM_LPrefix,@SPM_Name,@SPM_LX,@SPM_LY,@SPM_TX,@SPM_TY,@SPM_LI,@SPM_TI,@SPM_CNum,@SPM_TPrefix,@SPM_Height,@Stat)";
      ...
      {
         string sql = "INSERT INTO Sys_PD_Module (SPM_Module,SPM_LPrefix,SPM_Name,SPM_LX,SPM_LY,SPM_TX,SPM_TY,SPM_LI,SPM_TI,SPM_CNum,SPM_TPrefix,SPM_Height,Stat) VALUES (@SPM_Module,@SPM_LPrefix,@SPM_Name,@SPM_LX,@SPM_LY,@SPM_TX,@SPM_TY,@SPM_LI,@SPM_TI,@SPM_CNum,@SPM_TPrefix,@SPM_Height,@Stat);SELECT @@IDENTITY AS ReturnID;";
         if (string.IsNullOrEmpty(sys_PD_Module.SPM_Module))
         {
            idb.AddParameter("@SPM_Module", DBNull.Value);
         }
      ...
      /// </summary>
      public int Delete(Int64 sPM_ID)
      {
      ...
      /// </summary>
      public Sys_PD_Module GetByKey(Int64 sPM_ID)
      {
         Sys_PD_Module sys_PD_Module = new Sys_PD_Module();
         string sql = "SELECT  SPM_ID,SPM_Module,SPM_LPrefix,SPM_Name,SPM_LX,SPM_LY,SPM_TX,SPM_TY,SPM_LI,SPM_TI,SPM_CNum,SPM_TPrefix,SPM_Height,Stat FROM Sys_PD_Module WHERE 1=1 AND ((Stat is null) or (Stat=0) )  AND SPM_ID=@SPM_ID ";
         idb.AddParameter("@SPM_ID", sPM_ID);
         ...
         while(dr.Read())
         {
            if (dr["SPM_ID"] != DBNull.Value) sys_PD_Module.SPM_ID = Convert.ToInt64(dr["SPM_ID"]);
      ...
      public List<Sys_PD_Module> GetListByWhere(string strCondition)
      {
         ...
         string sql = "SELECT  SPM_ID,SPM_Module,SPM_LPrefix,SPM_Name,SPM_LX,SPM_LY,SPM_TX,SPM_TY,SPM_LI,SPM_TI,SPM_CNum,SPM_TPrefix,SPM_Height,Stat FROM Sys_PD_Module WHERE 1=1 AND ((Stat is null) or (Stat=0) ) ";
