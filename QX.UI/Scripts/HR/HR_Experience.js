var HR_Experience_GridControl = {
    setupHR_ExperienceGrid: function(grid, pager, search, dataurl) {
        grid.jqGrid({
            ...
            caption: '信息列表',
            footerrow: false,
            colNames: ['操作', '经历序号', '个人经历编码', '员工编码', '员工姓名', '经历类型', '经历单位', '经历职位', '简介', '备注', '', '', ''],
            colModel: [{ name: 'Edit', index: 'Edit', width: 100, align: 'center', sortable: false, hidden: false }, { name: 'EX_ID', index: 'EX_ID', width: 100, align: 'center', sortable: false, hidden: true },
...
{ name: 'Stat', index: 'Stat', width: 100, align: 'center', sortable: false, hidden: true}],
    ...
    Init: function(dataurl, targetPreFix) {
        ...
        HR_Experience_GridControl.setupHR_ExperienceGrid($('#' + gridobj), $('#' + pagerobj), $('#' + searchobj), dataurl);
    }
}
...
var HR_Exxperience_GridControl = {
    setupHR_ExxperienceGrid: function(grid, pager, search, dataurl) {
        grid.jqGrid({
            url: dataurl,
            mtype: "post",
            rowNum: 10,
            ...
            footerrow: false,
            colNames: ['操作', '经历序号', '个人经历编码', '员工编码', '员工姓名', '经历类型', '经历单位', '经历职位', '简介', '备注', '', '', ''],
            colModel: [{ name: 'Edit', index: 'Edit', width: 100, align: 'center', sortable: false, hidden: false }, { name: 'EXa_ID', index: 'EXa_ID', width: 100, align: 'center', sortable: false, hidden: true },
{ name: 'EX_Code', index: 'EX_Code', width: 100, align: 'center', sortable: false, hidden: false },
{ name: 'EX_StuffCode', index: 'EX_StuffCode', width: 100, align: 'center', sortable: false, hidden: false },
{ name: 'EX_StuffName', index: 'EX_StuffName', width: 100, align: 'center', sortable: false, hidden: false },
{ name: 'EX_Type', index: 'EX_Type', width: 100, align: 'center', sortable: false, hidden: false },
...
{ name: 'Stat', index: 'Stat', width: 100, align: 'center', sortable: false, hidden: true}],
    ...
    Init: function(dataurl, targetPreFix) {
        ...
        var pagerobj = targetPreFix + 'pager';
        var searchobj = targetPreFix + 'search';
        HR_Exxperience_GridControl.setupHR_ExxperienceGrid($('#' + gridobj), $('#' + pagerobj), $('#' + searchobj), dataurl);
    }
}