...
{ name: 'HRB_Bak1', index: 'HRB_Bak1', width: 100, align: 'center', sortable: false, hidden: true },
{ name: 'HRB_Bak2', index: 'HRB_Bak2', width: 100, align: 'center', sortable: false, hidden: true}],
            gridComplete: function() {
                ...
                for (var i = 0; i < ids.length; i++) {
                        ...
                        var objEvent = "onclick='javascript:HR_Benefit_GridControl.InitEdit(\"" + ret.HRB_Code + "\");";
