HR_Shared_GridControl = {
        ...
        grid.jqGrid({
            ...
            gridComplete: function() {
                ...
                for (var i = 0; i < ids.length; i++) {
                    ...
                    be = "<a href='/HR/HR_In/" + ret.HM_ECode + "'>编辑</a>";
        ...
        grid.jqGrid({
            ...
            gridComplete: function() {
                ...
                for (var i = 0; i < ids.length; i++) {
                    ...
                    be = "<a href='/HR/HR_TimeSheet/" + ret.TS_StuffCode + "'>编辑</a>";
        ...
        grid.jqGrid({
            ...
            gridComplete: function() {
                ...
                for (var i = 0; i < ids.length; i++) {
                    ...
                    be = "<a href='/HR/HR_AA/" + ret.AA_ECde + "'>编辑</a>";
                    grid.jqGrid('setRowData', ids[i], { Edit: be });
                }
            },
            userDataOnFooter: true
        ...
        grid.jqGrid({
            ...
            gridComplete: function() {
                ...
                for (var i = 0; i < ids.length; i++) {
                    ...
                    be = "<a href='/HR/HR_Evaluation/" + ret.Eva_StuffCode + "'>编辑</a>";
                    grid.jqGrid('setRowData', ids[i], { Edit: be });
                }
            },
            userDataOnFooter: true
        ...
        grid.jqGrid({
            ...
            gridComplete: function() {
                ...
                for (var i = 0; i < ids.length; i++) {
                    ...
                    be = "<a href='/HR/HR_Benefit/" + ret.HRB_ECode + "'>编辑</a>";
                    grid.jqGrid('setRowData', ids[i], { Edit: be });
                }
            },
            userDataOnFooter: true
    ...
    setupExGrid: function(grid, pager, search, dataurl) {
        grid.jqGrid({
            ...
            colModel: [
                        { name: 'Edit', index: 'Edit', width: 100, align: 'center', sortable: false, hidden: false },
                        { name: 'EX_StuffCode', index: 'EX_StuffCode', width: 80, align: 'center', sortable: false, hidden: false },
                        { name: 'EX_StuffName', index: 'EX_StuffName', width: 80, align: 'center', sortable: false, hidden: false },
                        { name: 'EX_Corrp', index: 'EX_Corrp', width: 100, align: 'center', sortable: false, hidden: false },
                        { name: 'EX_Title', index: 'EX_Title', width: 80, align: 'center', sortable: false, hidden: false },
                        { name: 'EX_Intro', index: 'EX_Intro', width: 100, align: 'center', sortable: false, hidden: false },
                        { name: 'EX_Start', index: 'EX_Start', width: 100, sortable: true, hidden: false },
            ...
            gridComplete: function() {
                ...
                for (var i = 0; i < ids.length; i++) {
                    ...
                    be = "<a href='/HR/HR_Experience/" + ret.EX_StuffCode + "'>编辑</a>";
                    grid.jqGrid('setRowData', ids[i], { Edit: be });
                }
            },
            userDataOnFooter: true
        ...
        grid.jqGrid({
            ...
            gridComplete: function() {
                ...
                for (var i = 0; i < ids.length; i++) {
                    ...
                    be = "<a href='/HR/HR_EduExperience/" + ret.EX_StuffCode + "'>编辑</a>";
                    grid.jqGrid('setRowData', ids[i], { Edit: be });
                }
            },
            userDataOnFooter: true
