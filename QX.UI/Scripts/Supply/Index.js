        ...
        grid.jqGrid({
            ...
            gridComplete: function() {
                ...
                for (var i = 0; i < ids.length; i++) {
                    ...
                    var create = "<a href='Create'><img src='../../Content/images/add1.png' border='0';alt='添加' /></a>&nbsp;";

                    be = "<a href='/Supply/Edit/" + ret.MV_CustCode + "'><img src='../../Content/images/edit1.png' border='0';alt='编辑' /></a>&nbsp;";
