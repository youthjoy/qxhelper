<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/BasePage.Master" Inherits="System.Web.Mvc.ViewPage<QX.Model.SD_Contract>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="ContractInfo">
        ...
        <%=Html.AutoBindForm<QX.Model.SD_Contract>("SD_ContractModule","SD_Contract_TOP",(QX.Model.SD_Contract)Model,false,false,false)%>
        ...
        <div id="tabs">
            ...
            <div id="tabs-1">
                <%=Html.AutoBindForm<QX.Model.SD_Contract>("SD_ContractModule", "SD_Contract", (QX.Model.SD_Contract)Model, false, false, false)%>
            </div>
        </form>
        <div id="tabs-2">
            ...
            <%=Html.SysComm_JqGrid("SD_ProjectModule", "All", "/Sales/ProjectWithContract/" + Model.SDC_Code, "", "", "Cust", "All", true)%>
            
            <%--工程路线--%>
            <%=Html.Common_ToolBarForListPage("SD_CTransModule", "SD_CTrans","toolbar:'false'")%>
            ...
            <table border="0" cellspacing="0" cellpadding="0" width="100%" style="margin-left: 10px">
                <tr>
                    ...
                    <td valign="top">
                        ...
                        <%--<%=Html.SysComm_JqGrid("SD_CPriceModule", "SD_CPrice", "/Sales/PriceFilter/" + Model.SDC_Code, "", "", "", "", true)%>--%>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div style="float: left">
        <input type='button' name='withfun' value='草稿' onclick='Contract_Operation.SaveDraft()' />
    <input type='button' name='withfun' value='提交' onclick='Contract_Operation.SaveData()' />
        <input type='button' name='button' value='返回' onclick='Contract_Operation.CancelEdit()' />
    </div>
    <%--参考--%>
